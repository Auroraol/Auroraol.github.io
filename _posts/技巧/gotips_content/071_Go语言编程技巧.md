...
来源: https://colobu.com/gotips/071.html

---

# Golang Tip #71: 用泛型让 sync.Pool 类型安全
## 什么是 sync.Pool?
原文链接：Golang Tip #71: sync.Pool, make it typed-safe with generics.在讲 sync.Pool 之前，对于那些不熟悉 sync.Pool的人来说，它是Go的标准库的一个特性，用于重用对象。
...
“我们为什么不检查转换过程中的错误呢？”泛型已经为我们确保了类型，所以我们不需要担心转换失败。
