...
来源: https://colobu.com/gotips/075.html

---

# Tip #75 使用singleflight优化多次调用
原始链接: Golang Tip #75: Optimize multiple calls with singleflight.假设您有一个从网络获取数据或执行 I/O 的函数，大约需要 3 秒钟：
