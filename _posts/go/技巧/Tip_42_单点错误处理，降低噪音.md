...
来源: https://colobu.com/gotips/042.html

---

# Tip #42 单点错误处理，降低噪音
原始链接：Golang Tip #42: Single Touch Error Handling, Less Noise.这是我以前处理错误的方式，假设我们有一个函数 A 调用函数 B，两个函数都处理错误，如下所示：
...
如果你选择返回错误不记录日志，考虑给错误添加更多上下文（参考[Tip #38](./038.html), 原链接[https://twitter.com/func25/status/...](https://twitter.com/func25/status/1764265328165753176)）
