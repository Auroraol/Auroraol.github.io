...
来源: https://colobu.com/gotips/076.html

---

# Tip #76 函数调用的结果回传
原始链接：Golang Tip #76: Result forwarding in function call当我刚开始使用go语言的时候，我发现有一个概念比较棘手：函数调用结果的回传。
...
这个技巧与我在之前提到的“must”函数结合使用时效果非常好。具体详见：[Golang Tip #44: Intentionally Stop with Must Functions](./044.html)
