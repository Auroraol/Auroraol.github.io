...
来源: https://colobu.com/gotips/012.html

---

# Tip #12 使用crypto/rand生成密钥，避免使用math/rand
原始链接：Golang Tip #12: Avoid using math/rand, use crypto/rand for keys instead.当你所在的项目需要生成一些密钥用来加密或者创建唯一标识的时候，那密钥的质量和安全性就尤其重要了。
### 为什么不使用math/rand？
