...
来源: https://colobu.com/gotips/069.html

---

# Tip #69 通过errgroup管理多个goroutine
原始链接： Golang Tip #69: Manage multiple goroutines with errgroup当我们处理一堆 goroutine 时，要处理错误并确保它们之间良好协同工作可能会有些困难。
...
![](images/069/002.png)
- `errg.done()`是一个标记 goroutine 完成的辅助函数。
