...
来源: https://colobu.com/gotips/077.html

---

# Tip #77 带缓冲的 channel 作为信号量来限制 goroutine 执行
原始链接：Golang Tip #77: Buffered channels as semaphores to limit goroutine execution当我们想要管理`有多少 goroutine 可以同时访问一个资源`时，使用信号量是一种可靠的方法。
