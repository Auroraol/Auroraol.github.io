...
来源: https://colobu.com/gotips/063.html

---

# Tip #63 避免使用time.Sleep()，它不能被context感知且无法被中断
原始链接： Golang Tip Tip #63: Avoid time.Sleep(), it's not context-aware and can't be interrupted.使用`time.Sleep`可能看起来很有用，但它不能被context 感知，也无法被中断。
