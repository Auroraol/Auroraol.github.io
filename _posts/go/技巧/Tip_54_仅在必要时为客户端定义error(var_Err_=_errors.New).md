...
来源: https://colobu.com/gotips/054.html

---

# Tip #54 仅在必要时为客户端定义error(var Err = errors.New)
原始链接：Golang Tips #54: Only define errors (var Err = errors.New) when it's necessary for your client一个在很多代码库中都有的常见误区是，为**每个**逻辑错误定义一个error，每个error都有一个高度描述性的名称和说明。
这种做法并不是总是必要的：
![](images/054/1.jpg)
