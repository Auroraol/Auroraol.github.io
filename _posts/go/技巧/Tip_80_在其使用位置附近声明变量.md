...
来源: https://colobu.com/gotips/080.html

---

# Tip #80 在其使用位置附近声明变量
原始链接：Golang Tip #80: Declare variables NEAR their usage这是一个在使用Go语言一段时间后的常见错误。
...
理想情况下，你希望尽可能接近使用变量的地方来声明它们：![](images/080/2.png)
