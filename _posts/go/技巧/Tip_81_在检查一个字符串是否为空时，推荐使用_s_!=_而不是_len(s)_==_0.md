...
来源: https://colobu.com/gotips/081.html

---

# Tip #81 在检查一个字符串是否为空时，推荐使用 s != "" 而不是 len(s) == 0
原始链接：Golang Tip #81: To check if a string is empty, prefer s != "" over len(s) == 0两种解决方案都是完全可以的，并且这两种技术在Go的标准库中都很常见。
但是它们有什么区别？为什么我们应该优先使用 s != ""？![](images/081/1.png)
