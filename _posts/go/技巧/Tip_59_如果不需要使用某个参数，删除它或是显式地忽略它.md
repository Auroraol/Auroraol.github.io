...
来源: https://colobu.com/gotips/059.html

---

# Tip #59 如果不需要使用某个参数，删除它或是显式地忽略它
原始链接：Golang Tip #59: If a parameter isn't needed, either drop it or ignore it on purpose在我们深入讨论这个技巧之前，让我们剖析下方例子中出现的问题：
![](images/059/1.png)
...
"为什么不直接删除这个参数呢？"如前文所述，删除该参数是该问题的解决方法之一。
