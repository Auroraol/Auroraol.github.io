...
来源: https://colobu.com/gotips/039.html

---

# Tip #39 避免在循环中使用defer，否则可能会导致内存溢出
原始链接：Golang Tip #39: Avoid defer in loops, or your memory might blow up.在 Go 中使用 defer 时，我们一般希望defer后面的函数能在当前函数返回之前被执行。![](images/039/001.png)
