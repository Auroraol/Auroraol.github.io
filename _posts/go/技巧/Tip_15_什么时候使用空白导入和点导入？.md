...
来源: https://colobu.com/gotips/015.html

---

# Tip #15 什么时候使用空白导入和点导入？
原始链接：Golang Tip #15: When to use Dot (.) Import and Blank (_) Import?## 空白导入（import _ "package"）
...
译者注：上面隐含了 mypackage_test.go 所在的包是 main 包。为了解决这个问题，测试文件声明自己为 mypackagetest 包，并使用点导入直接访问 mypackage 的标识符，就像它在 mypackage 内部定义的一样。
