...
来源: https://colobu.com/gotips/074.html

---

# Tip #74 使 time.Duration 清晰易懂
原始链接： Golang Tip #74: Make time.Duration clear and easy to understand在编码里处理时间间隔的时候，你会经常使用`time.Duration`类型。一个常见的问题可能会让代码变得混乱，那就是当你使用秒时：
![](images/074/001.png)
