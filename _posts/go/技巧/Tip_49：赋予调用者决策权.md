...
来源: https://colobu.com/gotips/049.html

---

# Tip #49：赋予调用者决策权
原始链接：Golang Tip #49: Give the Caller the Right to Make Decisions.想法是这样的：当你编写函数或包时，你必须决定：
...
“为什么不在我们的函数和调用者的函数里同时记录错误，以便更容易地追溯？”这个想法与[Tip #42：单次错误处理，减少噪音](./042.html)相关。
